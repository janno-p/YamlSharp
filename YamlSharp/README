...
X-Y-        A production string with an x- character and ending with a y- character, where x- and y- are any of the
            above prefixes

X+,X-Y+     A production as above, with the additional property that the matched content identation level is greater
...
[7]     c-collect-entry ::= “,”         A “,” (#x2C, comma) ends a flow collection entry.
...
[15]    c-tag ::= “!”                   The “!” (#x21, exclamation) is heavily overloaded for specifying node tags. It
                                        is used to denote tag handles used in tag directives and tag properties; to
                                        denote local tags; and as the non-specific tag for non-plain scalars.

[16]    c-literal ::= “|”               A “|” (7C, vertical bar) denotes a literal block scalar.
[17]    c-folded ::= “>”                A “>” (#x3E, greater than) denotes a folded block scalar.
[18]    c-single-quote ::= “'”          An “'” (#x27, apostrophe, single quote) surrounds a singlequoted flow scalar.
...
[45]    ns-esc-horizontal-tab ::= “t” | #x9     Escaped ASCII horizontal tab (#x9) character. This is useful at the
...
[51]    ns-esc-space ::= #x20                   Escaped ASCII space (#x20) character. This is useful at the start or
...
[59]    ns-esc-8-bit ::= “x”                    Escaped 8-bit Unicode character. ( ns-hex-digit × 2 )
[60]    ns-esc-16-bit ::= “u”                   Escaped 16-bit Unicode character. ( ns-hex-digit × 4 )
[61]    ns-esc-32-bit ::= “U”                   Escaped 32-bit Unicode character. ( ns-hex-digit × 8 )
...
[206]   c-forbidden ::= /* Start of line */ ( c-directives-end | c-document-end )
...
[211]   l-yaml-stream ::= l-document-prefix* l-any-document? ( l-document-suffix+ l-document-prefix* l-any-document?
